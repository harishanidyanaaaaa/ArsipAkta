<aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="{{ url('') }}/theme/assets/images/logo/logo.svg" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Data Akta</span>
            </a>
            <ul id="ddmenu_55" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('Akta-Index') }}"> Data Akta </a>
              </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Jenis Akta </span>
            </a>
            <ul id="ddmenu_4" class="collapse dropdown-nav">
            
              <li>
                <a href="{{ route('Jenis-Akta-Index') }}"> Semua Jenis Akta </a>
              </li>
              <li>
                <a href="{{ route('Jenis-Akta-Notaris') }}"> Akta Noatris </a>
              </li>
              <li>
                <a href="{{ route('Jenis-Akta-PPAT') }}"> Akta PPAT </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text"> Data Rekapitulasi </span>
            </a>
            <ul id="ddmenu_5" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('Rekap-Index') }}"> Data Rekapitulasi </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="{{ url('') }}/theme/assets/images/logo/logo-icon-big.svg" alt="Logo">
        </div>
